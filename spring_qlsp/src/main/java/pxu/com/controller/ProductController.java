...
public class ProductController {
	...
	@GetMapping(value = "/updatepath/{productId}") 
	public String updateform2(@PathVariable("productId") int id, Model model) {
		Product product = productService.finByid(id);
		model.addAttribute("product", product);
		return "update";
	}
	...
	public String view(@RequestParam("productId") Integer productid, Model model) {
